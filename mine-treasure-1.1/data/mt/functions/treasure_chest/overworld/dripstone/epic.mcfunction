setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"mt:chests/dripstone_treasure/dripstone_epic_treasure",CustomName:'{"text":"     Epic Dripstone Treasure","color":"dark_red","bold":false,"italic":false}'} destroy
