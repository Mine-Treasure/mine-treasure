setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"mt:chests/taiga_treasure/taiga_epic_treasure",CustomName:'{"text":"       Epic Taiga Treasure","color":"dark_red","bold":false,"italic":false}'} destroy
