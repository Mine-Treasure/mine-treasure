setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"mt:chests/jungle_treasure/jungle_epic_treasure",CustomName:'{"text":"      Epic Jungle Treasure","color":"dark_red","bold":false,"italic":false}'} destroy
