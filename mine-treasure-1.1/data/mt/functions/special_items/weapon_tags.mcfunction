...
#tags
effect give @s[tag=mt.res5] resistance 2 4 true
tag @s remove mt.res5

effect give @s[tag=mt.assa] strength 5 3 true
execute at @s[tag=mt.assa] run effect give @a[distance=0.1..20] darkness 5 1 true
tag @s remove mt.assa
