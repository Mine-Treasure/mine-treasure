...
execute if entity @s[scores={mt.selector=1..}] run function mt:treasure_chest/msg

# TREASURE SYSTEM
execute if entity @s[scores={treasure_obtain=..0}] run function mt:treasure_chest/guarantee
execute if entity @s[scores={mt.mined=1..}] run function mt:treasure_chest/start_ray
...
execute if entity @s[scores={mt.mined=1..}] run function mt:treasure_chest/tiers/stone_check_common
execute if entity @s[scores={mt.mined=1..}] run function mt:treasure_chest/tiers/stone_check_rare
execute if entity @s[scores={mt.mined=1..}] run function mt:treasure_chest/tiers/stone_check_epic
execute if entity @s[scores={mt.mined=1..}] run function mt:treasure_chest/tiers/stone_check_legendary
...
execute if entity @s[scores={mt.play_time=..40}] run function mt:playerload
