setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"mt:chests/swamp_treasure/swamp_epic_treasure",CustomName:'{"text":"       Epic Swamp Treasure","color":"dark_red","bold":false,"italic":false}'} destroy
