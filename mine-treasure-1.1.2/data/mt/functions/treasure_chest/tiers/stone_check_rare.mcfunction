...
execute if entity @s[scores={mt.break_diorite=1..,mt.rare_chance=..11}] store result score @s rare_treasure at @s anchored eyes positioned ^ ^ ^ anchored feet run function mt:treasure_chest/start_ray
execute if entity @s[scores={mt.break_andesite=1..,mt.rare_chance=..11}] store result score @s rare_treasure at @s anchored eyes positioned ^ ^ ^ anchored feet run function mt:treasure_chest/start_ray
execute if entity @s[scores={mt.break_granite=1..,mt.rare_chance=..11}] store result score @s rare_treasure at @s anchored eyes positioned ^ ^ ^ anchored feet run function mt:treasure_chest/start_ray
...
execute unless score @s mt.common_chance matches ..17 run function mt:random_number/treasure_chances/rare/range
