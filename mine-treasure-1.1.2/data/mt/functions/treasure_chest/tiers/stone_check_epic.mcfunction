...
execute if entity @s[scores={mt.break_diorite=1..,mt.epic_chance=..11}] store result score @s epic_treasure at @s anchored eyes positioned ^ ^ ^ anchored feet run function mt:treasure_chest/start_ray
execute if entity @s[scores={mt.break_andesite=1..,mt.epic_chance=..11}] store result score @s epic_treasure at @s anchored eyes positioned ^ ^ ^ anchored feet run function mt:treasure_chest/start_ray
execute if entity @s[scores={mt.break_granite=1..,mt.epic_chance=..11}] store result score @s epic_treasure at @s anchored eyes positioned ^ ^ ^ anchored feet run function mt:treasure_chest/start_ray
...
execute unless predicate mt:unless/epic run function mt:random_number/treasure_chances/epic/range
