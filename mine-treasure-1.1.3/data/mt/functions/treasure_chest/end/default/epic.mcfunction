setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"mt:chests/end_treasure/end_epic_treasure",CustomName:'{"text":"         Epic End Treasure","color":"dark_red","bold":false,"italic":false}'} destroy
